...
const AngaliaRipotiYaKilaSiku = ({ navigation }) => {
...
<View style={{
  ...
  {[
    { label: 'Marejesho (Tsh)', value: formatToThreeDigits(item.JumlaMarejeshoYaLeo) },
    { label: 'Faini (Tsh)', value: formatToThreeDigits(item.JumlaFainiLeo) },
    { label: 'Fomu + Bima (Tsh)', value: formatToThreeDigits(item.FomuNaBima) },
    { label: 'Baki Jana (Tsh)', value: formatToThreeDigits(item.BakiJana) },
    

    { label: 'Imetoka Kwa Bosi (Tsh)', value: formatToThreeDigits(item.ImetokaKwaBosi) },
    { label: 'Imetoka kituo jirani (Tsh)', value: formatToThreeDigits(item.ImetokaKituoJirani) },
    { label: 'Kituo zilipotoka (Tsh)', value: formatToThreeDigits(item.KituoIlichotokaHela) },
    { label: 'Mapato ya jumla (Tsh)', value: formatToThreeDigits(item.MapatoYaJumla) },
...
<View style={{
  ...
  {[
    { label: 'Mkopo (Tsh)', value: formatToThreeDigits(item.Mkopo) },
    { label: 'Posho (Tsh)', value: formatToThreeDigits(item.Posho) },
    { label: 'Imeenda kwa Bosi (Tsh)', value: formatToThreeDigits(item.ImeendaKwaBosi) },
    { label: 'Imeenda kituo jirani (Tsh)', value: formatToThreeDigits(item.ImeendaKituoJirani) },
    

    { label: 'Kituo zilipokwenda (Tsh)', value: formatToThreeDigits(item.KituoIlichoendaHela) },
    { label: 'Matumizi (Tsh)', value: formatToThreeDigits(item.MatumiziMengine) },
    { label: 'Matumizi ya jumla (Tsh)', value: formatToThreeDigits(item.MatumiziYaJumla) },
...
<View style={{
  ...
  {[
    { label: 'Inakabidhiwa (Tsh)', value: formatToThreeDigits(item.Balance) },
    { label: 'Ripoti Imeandaliwa Na', value: formatToThreeDigits(item.ImeweingizwaNa) },
...
export default AngaliaRipotiYaKilaSiku;
